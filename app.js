...
app.get('/destination/asia',function(req,res){    
    res.sendFile(path.join(__dirname+'/views/asia.html'));
});
app.get('/destination/europe',function(req,res){    
    res.sendFile(path.join(__dirname+'/views/europe.html'));
});
app.get('/destination/africa',function(req,res){    
    res.sendFile(path.join(__dirname+'/views/africa.html'));
});
app.get('/destination/australia',function(req,res){    
    res.sendFile(path.join(__dirname+'/views/australia.html'));
});
app.get('/destination/namerica',function(req,res){    
    res.sendFile(path.join(__dirname+'/views/namerica.html'));
});
app.get('/destination/samerica',function(req,res){    
